...
extension PasswordStatusView {
    func updateDisplay(_ text: String) {
        let lengthAndNoSpaceMet = PasswordCriteria.lenghtCriteriaMet(text)
        ...
        if shouldResetCriteria {
            ...
            lengthAndNoSpaceMet ? lenghtCriteriaView.isCriteriaMet = true : lenghtCriteriaView.reset()
